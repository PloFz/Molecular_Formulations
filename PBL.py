...
def solvation_energy(mol_name, mesh_density, 
	...
	#grid = bempp.api.shapes.regular_sphere(mesh_density)
	#grid.plot()
	...
	phi_q =charges_potential(x, x_q, dirichl_space, neumann_space)
...
def direct_formulation(dirichl_space, neumann_space, q, x_q, ep_in, ep_ex, kappa):
	...
	# Function to proyect the carges potential to the boundary
