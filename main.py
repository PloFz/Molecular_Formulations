...
n_boundary_elements_ex = np.array([l['n_of_elements_ex']
...
radius_s = np.array([l['stern_radius'] for l in dicts if l['formulation']=='stern_d'])
...
print 'N of external elements:  ', n_boundary_elements_ex
...
stern_rad.plot(radius_s, energy_s, marker='o', color='k')

stern_rad.set_xlabel('N of elements')
